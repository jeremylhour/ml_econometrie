### High dimension and IV, demand application 
### Replicates results from 
### Chernozhukov, V., Hansen, C. et Spindler, M. (2015). Post-Selection and Post-Regularization
### Inference in Linear Models with Many Controls and Instruments. American Economic Review, 105(5):  486-90
### Edited: 12/2022
####################################################
