...
path = "C:/Users/chris/Dropbox/HD Econometrics_p/Codes_2022/chapter8_het/GML_simulations/"
path1 = "C:/Users/chris/Dropbox/HD Econometrics_p/Codes_2022/chapter8_het/"
source(paste0(path,"ML_Functions.R"))
ptm <- proc.time()
...
# data        <- read.dta13(paste0(path1,"data_rep.dta"))
...
names <- c("Outcome")    # vector of labels for outcome variables
Y     <- c("Y")     # vector of outcome variables
D     <- c("D") # vector of treatment variables
...
affected       <- c("X1","X2")     # characteristics for most/least affected analysis
names_affected <- c("X1","X2")    # characteristics for most/least affected analysis
...
name= "W:/Bureau/HD Econometrics/MLInference-master/MLInference-master/DoubleML/EL1"
